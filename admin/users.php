            ...
            <div class="card mt-4">
                <div class="card-body shadow">
                    <div class="mb-3 d-flex justify-content-between">
                        <h5 class="card-title mt-3">USER</h5>
                        <?php 
                        ...
                        <div id="test_user">
                            <div class="text-end my-2 mx-5">
                                <a href="javascript:void(0)" onclick="seen_all('2')" class="btn btn-sm btn-success">READ
                                    ALL </a>
                                <a href="javascript:void(0)" onclick="del_all('2')" class="btn btn-sm btn-danger">DELETE
                                    ALL </a>
                            </div>
                        </div>
                    </div>
